...
SELECT *
FROM empleados
WHERE departamento <> 'recursos humanos'; --departamento <> 'recursos humanos' → selecciona todos los registros donde el departamento no sea “recursos humanos”.
...
--DISTINCT hace que si hay filas repetidas con los mismos valores en columna1 (o combinación de columnas), solo aparezca una vez.
--Si no usas DISTINCT, el SELECT devuelve todas las filas, incluyendo duplicados.

-- 10. recupera los empleados que tienen un salario mayor o igual a 3500 y están en el departamento desarrollo.
SELECT *
FROM empleados
WHERE salario >= 3500
  AND departamento = 'desarrollo';